...
switch(waktoonyabro){
case 0: waktoonyabro = `Selamat Malam Nanz..🌃`; break;
case 1: waktoonyabro = `Selamat Malam Nanz..🌃`; break;
case 2: waktoonyabro = `Selamat Malam Nanz..🌃`; break;
case 3: waktoonyabro = `Selamat Pagi Nanz..✨`; break;
case 4: waktoonyabro = `Selamat Pagi Nanz..✨`; break; 
case 5: waktoonyabro = `Selamat Pagi Nanz..✨`; break;
case 6: waktoonyabro = `Selamat Pagi Nanz..✨`; break;
case 7: waktoonyabro = `Selamat Pagi Nanz..✨`; break;
case 8: waktoonyabro = `Selamat Pagi Nanz..✨`; break;
case 9: waktoonyabro = `Selamat Pagi Nanz..✨`; break;
case 10: waktoonyabro = `Selamat Pagi Nanz..✨`; break;
case 11: waktoonyabro = `Selamat Siang Nanz..🔥`; break; 
case 12: waktoonyabro = `Selamat Siang Nanz..🔥`; break;
case 13: waktoonyabro = `Selamat Siang Namz..🔥`; break;
case 14: waktoonyabro = `Selamat Siang Nanz..🔥`; break;
case 15: waktoonyabro = `Selamat Sore Nanz..🌇`; break;
case 16: waktoonyabro = `Selamat Sore Nanz..🌇`; break;
case 17: waktoonyabro = `Selamat Sore Nanz..🌇`; break;
case 18: waktoonyabro = `Selamat Malam Nanz..🌃`; break; 
case 19: waktoonyabro = `Selamat Malam Nanz..🌃`; break;
case 20: waktoonyabro = `Selamat Malam Nanz..🌃`; break;
case 21: waktoonyabro = `Selamat Malam Nanz..🌃`; break;
case 22: waktoonyabro = `Selamat Malam Nanz..🌃`; break; 
case 23: waktoonyabro = `Selamat Malam Nanz..🌃`; break;
}
...
const starts = async (kurr = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('Nanz Base', {
		font: 'Standard',
